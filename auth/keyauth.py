...
class api:
    ...
    def register(self, user, password, license, hwid=None):
        ...
        if json["success"]:
            ...
            if 'Username already taken, choose a different one' in error_message:
                return 'Username Taken'
            elif 'Invalid license key' in error_message:
                return 'Invalid License'
            elif 'License key has already been used' in error_message:
                return 'Used License'
            elif 'Your license is banned' in error_message:
                return 'Banned'
            else:
                print(error_message)
                sys.exit()
    ...
    def login(self, user, password, hwid=None):
        ...
        if json["success"]:
            ...
            elif 'Password does not match' in error_message:
                return 'Invalid Password'
            elif 'No active subscriptions found' in error_message:
                return 'Expired'
            elif 'Ask for a HWID reset' in error_message:
                return 'Invalid HWID'
            elif 'The user is banned' in error_message:
                return 'Banned'
            else:
                print(error_message)
                sys.exit()
